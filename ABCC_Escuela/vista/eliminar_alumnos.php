<div class="container-fluid">
    <div class="row main">
        ...
        while ($row = $sentencia->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo "<td> <a href='../controlador/script_php/eliminar_alumno.php?numControl=" . $row['numControl'] . "' title='Eliminar' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a> </td>";
            echo "</tr>";
        }
